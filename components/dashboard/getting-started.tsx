      ...
      <svg viewBox="0 0 120 120" className="h-full w-full -rotate-90">
        ...
        <defs>
          <linearGradient id="ob-ring" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#FA531C" />
...
export function GettingStarted({
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-7">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-[#FA531C]/[0.07] via-pink-500/[0.05] to-transparent p-6 sm:p-8">
        <div className="pointer-events-none absolute -right-16 -top-16 h-56 w-56 rounded-full bg-[#FA531C]/10 blur-[70px]" />
        <div className="relative flex flex-col-reverse items-start gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <div className="inline-flex items-center gap-2 rounded-full border border-pink-500/25 bg-pink-500/10 px-3 py-1.5 text-xs font-semibold text-pink-500 dark:text-pink-300">
      ...
      {allDone && (
        <div className="relative overflow-hidden rounded-2xl border border-pink-500/25 bg-gradient-to-br from-[#FA531C]/10 via-pink-500/10 to-transparent p-5 animate-in fade-in-0 zoom-in-95 duration-500 motion-reduce:animate-none">
          <div className="flex items-start gap-4">
            <div className="h-11 w-11 shrink-0 rounded-2xl bg-pink-500/15 flex items-center justify-center">
            ...
            <div className="min-w-0">
              ...
              {bonusEarned && (
                <div className="mt-3 inline-flex items-center gap-2 rounded-xl border border-pink-500/30 bg-pink-500/10 px-3 py-1.5 text-sm font-semibold text-pink-500 dark:text-pink-300">
      ...
      <div>
        ...
        <ol className="relative pl-1">
          ...
          <span
            aria-hidden
            className="absolute left-[19px] top-5 w-0.5 rounded-full bg-gradient-to-b from-[#FA531C] to-pink-500 transition-[height] duration-1000 ease-out motion-reduce:transition-none"
              ...
              <li key={step.key} className="relative flex items-stretch gap-4 pb-3 last:pb-0">
                ...
                <div className="relative z-10 shrink-0 pt-3">
                  <div
                    className={`flex h-10 w-10 items-center justify-center rounded-full border-2 bg-background transition-colors ${
                      isDone
                        ? "border-transparent bg-gradient-to-br from-[#FA531C] to-pink-500 text-white"
                        : isNext
                          ? "border-[#FA531C] text-[#FA531C] ring-4 ring-[#FA531C]/15"
                ...
                <Link
                  ...
                  className={`group flex flex-1 items-center gap-3 rounded-2xl border p-4 transition-all ${ELEVATED} ${
                    isNext
                      ? "border-[#FA531C]/40 bg-[#FA531C]/[0.05] hover:border-[#FA531C]/60"
                      : isDone
                ...
                >
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {isNext && (
                        <span className="rounded-full bg-[#FA531C]/15 px-2 py-0.5 text-[11px] font-bold uppercase tracking-wide text-[#FA531C]">{t("statusNext")}</span>
                      )}
                      {isDone && (
                  ...
                  {!isDone && (
                    <span className={`shrink-0 inline-flex items-center gap-1 text-xs font-bold ${isNext ? "text-[#FA531C]" : "text-muted-foreground group-hover:text-foreground"}`}>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          {TIPS.map((tip) => {
            const inner = (
              <>
                <div className="h-9 w-9 rounded-xl bg-[#FA531C]/10 flex items-center justify-center mb-2.5">
                  <tip.icon className="h-4 w-4 text-[#FA531C]" />
                </div>
            ...
            const cls = `block rounded-2xl border border-border bg-card p-4 hover:border-[#FA531C]/30 hover:-translate-y-0.5 transition-all ${ELEVATED}`;
            return tip.external ? (
