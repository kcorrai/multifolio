  ...
  return (
    <div className="md:hidden">
      <button
        ...
        aria-expanded={open}
        className="flex h-9 w-9 items-center justify-center rounded-lg text-slate-600 dark:text-[#6B4A3C] hover:bg-slate-100 dark:hover:bg-white/8 transition-colors cursor-pointer"
      >
      ...
      {open && createPortal(
        <div className="fixed inset-0 z-50">
          ...
          <div className="absolute inset-x-0 top-0 bg-white dark:bg-[#3A241B] border-b border-slate-200 dark:border-white/10 shadow-2xl px-6 py-4">
            ...
            <div className="flex flex-col gap-2 pt-4">
              {isLoggedIn ? (
                <Button asChild className="font-semibold bg-pink-600 hover:bg-pink-500 text-white">
