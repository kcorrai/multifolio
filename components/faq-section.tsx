...
export async function FaqSection() {
  ...
  return (
    <section id="faq" className="border-t border-slate-200 dark:border-white/5 bg-slate-100/60 dark:bg-[#FFFAF3]/40 py-24">
      <JsonLd data={faqLd} />
      <div className="mx-auto max-w-3xl px-8">
        <ScrollReveal>
          <div className="text-center space-y-3 mb-12">
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-pink-400">{t("faq.eyebrow")}</p>
        ...
        <div className="space-y-3">
          {FAQ_KEYS.map((key, i) => (
            <ScrollReveal key={key} delay={i * 60}>
              <details className="group rounded-2xl border border-slate-200 dark:border-white/8 bg-white dark:bg-[#FFFAF3] px-5 py-4">
                ...
                <p className="mt-3 text-sm text-slate-500 dark:text-[#6B4A3C] leading-relaxed font-medium">
