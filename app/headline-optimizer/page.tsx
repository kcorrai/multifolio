// Herkese açık başlık optimize edici (SEO aracı / edinim kancası — /rate deseni):
// profil başlığını kriterlere göre puanla + öneri. Tamamen istemcide; auth/AI/kredi yok.
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: t("metaTitle"), description: t("metaDescription"), alternates: { canonical: "/headline-optimizer" } };
}
