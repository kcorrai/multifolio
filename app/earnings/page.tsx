// Herkese açık net kazanç hesaplayıcı (SEO aracı / edinim kancası — /analyze
// deseni): "Elime net ne geçer?" — komisyon + transfer + vergi → net.
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: t("metaTitle"), description: t("metaDescription"), alternates: { canonical: "/earnings" } };
}
